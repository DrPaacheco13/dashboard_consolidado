            ...
            <div class="row">
                @if ($idmall == 4)
                    <div class="col-md-6 card shadow-sm">
                        <div id="EntradaHoy"></div>
                    </div>
                    <div class="col-md-6 card shadow-sm">
                        <div id="containerCamarasHoy"></div>
                    </div>
                @else
                    <div class="col-xl-12 card shadow-sm">
                        <div id="EntradaHoy" class="col-md-12 shadow-sm" style="margin-top: 15px;"></div>
                    </div>
                @endif
            </div>
        </div>
